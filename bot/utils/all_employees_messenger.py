...
async def all_employees_messenger(files_id, caption, bot):
    ...
    for employer_id in employers:
        try:
            ...
            if not chat.id:
                print(f"Бот не может отправлять сообщения в чат {employer_id}.")
                continue
            ...
            print(f"Произошла ошибка при отправке в чат {employer_id}: {e}")